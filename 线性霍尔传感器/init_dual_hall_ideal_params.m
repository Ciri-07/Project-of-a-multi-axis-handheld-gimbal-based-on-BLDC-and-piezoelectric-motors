...
hall_vref_v = 3.3;              % V, ADC / Hall supply reference for signal display
hall_offset_v = hall_vref_v/2;  % V, ideal mid-supply bias
...
hall_theta0_rad = 0;            % rad, installation zero offset
